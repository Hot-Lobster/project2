...
class Login extends Component {
  constructor(props) {
    ...
    this.createNewUserAndAuthenticate = this.createNewUserAndAuthenticate.bind(
      this
    );
  }
      ...
      .catch(error => {
        switch (error.code) {
          ...
          case "auth/user-not-found":
            this.createNewUserAndAuthenticate(
              this.state.inputEmail,
              this.state.inputPassword
            );
            break;
      ...
      <div id="login" className="container">
        <form noValidate className="center">
          ...
          <div className="message">
            You can use any e-mail, as long as you remember the password for it.
            We won't ever send you anything.
          </div>
        </form>
      </div>
    );
